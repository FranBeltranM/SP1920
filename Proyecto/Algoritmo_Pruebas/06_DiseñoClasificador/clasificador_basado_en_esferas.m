...
load('../01_GenerarMaterial/ImagenesEntrenamiento_Calibracion.mat');
load('../02_ExtracionDatos/VariablesGeneradas/conjunto_de_datos.mat');
load('../06_DiseñoClasificador/VariablesGeneradas/datos_multiples_esferas.mat')
