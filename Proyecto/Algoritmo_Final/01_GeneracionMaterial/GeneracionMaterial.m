...
objeto_avi = VideoWriter('./01_ColorAzul.avi', 'Uncompressed AVI');
...
% Los 8 primeros frames son descartados, debido a que
% es donde aparece mi persona para comprobar la originalidad del vídeo.

% Además se han elegido manualmente 4 frames de fondo,
% donde aparece mi mano sin el objeto en cuestión.
...
save('./GeneracionImagenesEntrenamiento_Calibracion', 'imagenes')
