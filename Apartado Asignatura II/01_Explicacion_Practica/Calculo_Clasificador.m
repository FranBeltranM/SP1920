function [mCov, coef_corr1, coef_corr2, numDatosClase1, numDatosClase2, numDatos, d1, d2, d12, coeficientes_d12, Acc1, Acc2] = Calculo_Clasificador(X, Y, Tipo)
    ...
    mCov_clase1 = mCov(:,:,1);
    coef_corr1 = funcion_calcula_coeficiente_correlacion_lineal_2_variables(mCov_clase1);

    mCov_clase2 = mCov(:,:,2);
    coef_corr2 = funcion_calcula_coeficiente_correlacion_lineal_2_variables(mCov_clase2);
