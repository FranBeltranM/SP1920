...
mCov_clase1 = mCov(:,:,1);
coef_corr = funcion_calcula_coeficiente_correlacion_lineal_2_variables(mCov_clase1)

mCov_clase2 = mCov(:,:,2);
coef_corr = funcion_calcula_coeficiente_correlacion_lineal_2_variables(mCov_clase2)
...
% SE CUMPLEN TODAS LAS CONDICIONES DE APLICACIÓN PAR LA APLICACIÓN DE MDM
